...
could have included a different class the list, and had methods like 'append' or 'remove'
...
const nunList = new ListNode(1, new ListNode(2, new ListNode(2, new ListNode(1))));
console.log(isPalindrome(nonPalindromeList)); // false