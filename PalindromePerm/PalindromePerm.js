/*
*Code Review* : Alex Alvarez
Successfully ran other iterations of false outcomes, 
needs to identify permutations of a palindrome: 'taco tac' should return true
*/
...
console.log(isPalindrome('tac o cta'));